...
import "./kendra-kyc.css"; // Your CSS for KYC form styling
import { useNavigate } from 'react-router-dom';
import Qrcode from '../../../assets/images/QrCode.jpeg';


function KendraReviewandupdate() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert(`KYC updated successfully with ID: ${response.data.object.userId}`);
            console.log(response.data);
            Navigate("thankyou")
        } catch (error) {
...
export default KendraReviewandupdate;
